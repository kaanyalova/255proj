...
export class Bullet extends Actor {
	...
	constructor(
		...
		const colliderRect = new Rectangle(100, 100, this.BULLET_SIZE, this.BULLET_SIZE);
	...
	override tick(game: Game, deltaTime: number): void {
		const didCollide = game.checkCollisionWithLayer(this.collider, CollisionLayer.BULLETS);
